/* ************************************************************************
*   File: boards.h                                      Part of RavenMUD  *
...
*  Update to from tbamud 3.59 source code 05.15.09 -Xiuh                  *
************************************************************************ */
#ifndef _BOARDS_H_
#define _BOARDS_H_
...
Other stuff.
============================================================================ */
#define NUM_OF_BOARDS		67	 /* change if needed! */
#define MAX_BOARD_MESSAGES 	150      /* arbitrary -- change if needed */
