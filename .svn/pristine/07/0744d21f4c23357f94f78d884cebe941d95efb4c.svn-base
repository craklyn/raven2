...
void assign_mobiles(void)
{
  ...
  */
  ...
  // ASSIGNMOB( 41299, receptionist);
   ...
   ASSIGNMOB( 37814, guild_guard );
   ASSIGNMOB( 37815, receptionist );
   ASSIGNMOB( 37155, receptionist );

   // Salt Mine Hold, clan #22
   ASSIGNMOB( 37820, guild_guard );
   ASSIGNMOB( 37823, receptionist );
  //   ASSIGNMOB( 37823, bank );
  
   // Rapture, clan #23
   ASSIGNMOB( 29301, guild_guard );
   ASSIGNMOB( 29302, receptionist );  
...
void assign_objects(void)
{
    ...
    ASSIGNOBJ(37815, gen_board); /* Black blood */
    ASSIGNOBJ(37828, gen_board); /* Salt mine hold */
    ASSIGNOBJ(29303, gen_board); /* Rapture */
}
