...
struct board_info_type board_info[NUM_OF_BOARDS] = {
  {3097, LVL_IMMORT,  LVL_LRGOD, LVL_GOD,    SYS_ETC"board.freeze",  0}, // 1
  {3098, LVL_IMMORT, LVL_IMMORT, LVL_GOD,    SYS_ETC"board.immort",  0},
  {18111,       0,        5,     LVL_DGOD,    SYS_ETC"board.mort",    0},
  {1201, LVL_IMMORT, LVL_IMMORT, LVL_GOD,    SYS_ETC"board.general", 0},
  {20150,       0,   LVL_IMMORT, LVL_GOD,    SYS_ETC"board.quest",   0},
  {18123,       0,        5,     LVL_DGOD,   SYS_ETC"board.advert",  0},
  {1203,    LVL_GOD,    LVL_GOD, LVL_GOD,    SYS_ETC"board.vex",     0},
  {1204,        0,   LVL_IMMORT, LVL_GOD,    SYS_ETC"board.policy",  0},
  {1208, LVL_IMMORT, LVL_IMMORT, LVL_GOD,    SYS_ETC"board.kai",     0},
  {1209, LVL_IMMORT, LVL_IMMORT, LVL_GOD,    SYS_ETC"board.digs",    0}, // 10
  {1210, LVL_IMMORT, LVL_IMMORT, LVL_DGOD,   SYS_ETC"board.hasana",  0},
  {1211, LVL_IMMORT, LVL_IMMORT, LVL_GOD,    SYS_ETC"board.memnoch", 0},
  {1215, LVL_IMMORT, LVL_IMMORT, LVL_GOD,    SYS_ETC"board.diamond", 0},
  {1216, LVL_IMMORT, LVL_IMMORT, LVL_DGOD,   SYS_ETC"board.mortius", 0},
  {1280, LVL_IMMORT, LVL_IMMORT, LVL_DGOD,   SYS_ETC"board.imhotep", 0},
  {3099,        1,        1,     LVL_IMMORT, SYS_ETC"board.newbie",  0},
  {1287,       10,       10,     LVL_DGOD,   SYS_ETC"board.guilds",  0},
  {1288,       10,       10,     LVL_DGOD,   SYS_ETC"board.de",      0},
  {1289,       10,       10,     LVL_DGOD, SYS_ETC"board.mu",        0}, //20
  {1290,       10,       10,     LVL_DGOD, SYS_ETC"board.as",        0},
  {1291,       10,       10,     LVL_DGOD, SYS_ETC"board.cl",        0},
  {1292,       10,       10,     LVL_DGOD, SYS_ETC"board.sl",        0},
  {1294,       10,       10,     LVL_DGOD, SYS_ETC"board.sd",        0},
  {1295,       10,       10, LVL_DGOD, SYS_ETC"board.th",            0},
  {1296,       10,       10, LVL_DGOD, SYS_ETC"board.wa",            0},
  {1297,       10,       10, LVL_DGOD, SYS_ETC"board.ra",            0},
  {38000,      10,       10, LVL_DGOD, SYS_ETC"board.waidea",      0},
  {38100,      10,       10, LVL_DGOD, SYS_ETC"board.raidea",      0},
  {38200,      10,       10, LVL_DGOD, SYS_ETC"board.slidea",      0}, //30
  {38300,      10,       10, LVL_DGOD, SYS_ETC"board.clidea",      0},
  {38400,      10,       10, LVL_DGOD, SYS_ETC"board.skidea",      0},
  {38500,      10,       10, LVL_DGOD, SYS_ETC"board.dkidea",      0},
  {38600,      10,       10, LVL_DGOD, SYS_ETC"board.muidea",      0},
  {38700,      10,       10, LVL_DGOD, SYS_ETC"board.sdidea",      0},
  {38900,      10,       10, LVL_DGOD, SYS_ETC"board.asidea",      0},
  {38001,      10,       10, LVL_DGOD, SYS_ETC"board.wachal",      0},
  {38101,      10,       10, LVL_DGOD, SYS_ETC"board.rachal",      0},
  {38201,      10,       10, LVL_DGOD, SYS_ETC"board.slchal",      0},
  {38301,      10,       10, LVL_DGOD, SYS_ETC"board.clchal",      0}, //40
  {38401,      10,       10, LVL_DGOD, SYS_ETC"board.skchal",      0},
  {38601,      10,       10, LVL_DGOD, SYS_ETC"board.muchal",      0},
  {38701,      10,       10, LVL_DGOD, SYS_ETC"board.sdchal",      0},
  {38801,      10,       10, LVL_DGOD, SYS_ETC"board.thchal",      0},
  {38901,      10,       10, LVL_DGOD, SYS_ETC"board.aschal",      0},
  {19301,      10,       10, LVL_DGOD, SYS_ETC"board.clan2",       0},
  {1275,       10,       10, LVL_DGOD, SYS_ETC"board.clan1",       0},
  {19310,      10,       10, LVL_DGOD, SYS_ETC"board.clan3",       0},
  {19314,      10,       10, LVL_DGOD, SYS_ETC"board.clan13",      0},
  {19320,      10,       10, LVL_DGOD, SYS_ETC"board.clan4",       0}, //50
  {19324,      10,       10, LVL_DGOD, SYS_ETC"board.clan4b",      0},
  {19325,      10,       10, LVL_DGOD, SYS_ETC"board.clan4c",      0},
  {19330,      10,       10, LVL_DGOD, SYS_ETC"board.clan5",       0},
  {19340,      10,       10, LVL_DGOD, SYS_ETC"board.clan6",       0},
  {19353,      10,       10, LVL_DGOD, SYS_ETC"board.clan7a",      0},
  {19355,      10,       10, LVL_DGOD, SYS_ETC"board.clan7b",      0},
  {19370,      10,       10, LVL_DGOD, SYS_ETC"board.clan8",       0},
  {19380,      10,       10, LVL_DGOD, SYS_ETC"board.clan9",       0},
  {19390,      10,       10, LVL_DGOD, SYS_ETC"board.clan10",      0},
  {19397,      10,       10, LVL_DGOD, SYS_ETC"board.clan11",      0}, //60
  {41299,      10,       10, LVL_DGOD, SYS_ETC"board.avenge",      0},
  {19318,      10,       10, LVL_DGOD, SYS_ETC"board.clan.republic", 0},
  {1266,       10,       10, LVL_DGOD, SYS_ETC"board.clan.gm",     0},
  {37815,      10,       10, LVL_DGOD, SYS_ETC"board.clan.21",     0}, 
  {37828,      10,       10, LVL_DGOD, SYS_ETC"board.clan.22",     0}, //65
  {29303,      10,       10, LVL_DGOD, SYS_ETC"board.clan.23",     0},
  {1249, LVL_IMMORT, LVL_IMMORT, LVL_GOD, SYS_ETC"board.1249",     0}
};
...
static void init_boards(void)
{
    ...
    for (i = 0; i < NUM_OF_BOARDS; i++) {
        if ((BOARD_RNUM(i) = real_object(BOARD_VNUM(i))) == NOTHING) {
            mlog("SYSERR: Fatal board error: board vnum %d does not exist!",
                    BOARD_VNUM(i));
            fatal_error = 1;
        }
        num_of_msgs[i] = 0;
...
SPECIAL(gen_board)
{
    ...
    if ((board_type = find_board(ch)) == -1) {
        mlog("SYSERR:  degenerate board!  (what the hell...)");
        return (0);
    }
    if (cmd == ACMD_WRITE)
...
int board_write_message(int board_type, struct char_data *ch, char *arg, struct obj_data *board)
{
    ...
    if (GET_LEVEL(ch) < WRITE_LVL(board_type)) {
        sendChar(ch, "You are not holy enough to write on this board.\r\n");
        return (1);
    }

    if (PLR_FLAGGED(ch, PLR_SHUNNED)) {
        sendChar(ch, "JSj j s88-1@#@$^^^^^\n");
        sendChar(ch, "c");
        sendChar(ch, "*** Error *** Socket descruW9irj3n133 4");
        WAIT_STATE(ch, PULSE_VIOLENCE * 10);
        return (1);
    }

    if (IS_SET_AR(world[IN_ROOM(ch)].room_flags, ROOM_CLAN) &&
            (world[IN_ROOM(ch)].clan_id != GET_CLAN(ch)) &&
            (GET_LEVEL(ch) < LVL_GOD)) {
        sendChar(ch, "You should consider joining this clan before writing on their board.\r\n");
        return (1);
    }

    if (num_of_msgs[board_type] >= MAX_BOARD_MESSAGES) {
        sendChar(ch, "The board is full.\r\n");
        return (1);
    }
    if ((NEW_MSG_INDEX(board_type).slot_num = find_slot()) == -1) {
        sendChar(ch, "The board is malfunctioning - sorry.\r\n");
        mlog("SYSERR: Board: failed to find empty slot on write.");
        return (1);
    }
    /* skip blanks */
    skip_spaces(&arg);
    ...
    if (!*arg) {
        sendChar(ch, "We must have a headline!\r\n");
        return (1);
    }

    /* No blinky purple and green headlines please. */
    if (!mortal_color(arg, ch))
        return (1);

    ct = time(0);
    strftime(tmstr, sizeof (tmstr), "%b %d %y", localtime(&ct));

    snprintf(buf2, sizeof (buf2), "(%s)", GET_NAME(ch));
    snprintf(buf, sizeof (buf), "%s %-14s :: %s", tmstr, buf2, arg);
    NEW_MSG_INDEX(board_type).heading = strdup(buf);
    NEW_MSG_INDEX(board_type).level = GET_LEVEL(ch);

    sendChar(ch, "Write your message.  (/s saves /h for help)\r\n\r\n");
...
void board_add_message(int board_type, char *heading, char *body, char *poster)
{
    time_t ct;
    char buf[MAX_INPUT_LENGTH], tmstr[MAX_STRING_LENGTH];

    if (num_of_msgs[board_type] >= MAX_BOARD_MESSAGES) {
        mlog("SYSERR: Board_add: board is full.");
        return;
    }

    if ((NEW_MSG_INDEX(board_type).slot_num = find_slot()) == -1) {
        mlog("SYSERR: Board_add: failed to find empty slot on write.");
        return;
    }
    ...
    snprintf(buf, sizeof (buf), "%s (%-10s)   :: %s", tmstr, poster, heading);
    NEW_MSG_INDEX(board_type).heading = strdup(buf);
    NEW_MSG_INDEX(board_type).level = 51;

    msg_storage[NEW_MSG_INDEX(board_type).slot_num] = str_dup(body);

    num_of_msgs[board_type]++;
}

int
board_show_board(int board_type, struct char_data *ch, char *arg, struct obj_data *board)
{
    int i;
    ...
    if (GET_LEVEL(ch) < READ_LVL(board_type)) {
        sendChar(ch, "You try but fail to understand the holy words.\r\n");
        return (1);
    }
    ...
    if (IS_SET_AR(world[IN_ROOM(ch)].room_flags, ROOM_CLAN) &&
            (world[IN_ROOM(ch)].clan_id != GET_CLAN(ch)) &&
            (GET_LEVEL(ch) < LVL_GOD)) {
        sendChar(ch, "Discerning anything worthwhile is difficult, due to the cryptic nature of this clan.\r\n");
        return (1);
    }
    act("$n studies the board.", TRUE, ch, 0, 0, TO_ROOM);

    if (!num_of_msgs[board_type])
        sendChar(ch, "This is a bulletin board.  Usage: READ/REMOVE <messg #>, WRITE <header>.\r\nThe board is empty.\r\n");
    else {
        size_t len = 0;
        int nlen;
        ...
        for (i = 0; i < num_of_msgs[board_type]; i++) {
            ...
            nlen = snprintf(buf + len, sizeof (buf) - len, "%-2d : %s\r\n&00", i + 1, MSG_HEADING(board_type, i));
            if (len + nlen >= sizeof (buf) || nlen < 0)
                break;
            len += nlen;
        }
...
fubar:
    mlog("SYSERR: Board %d is fubar'd.", board_type);
    sendChar(ch, "Sorry, the board isn't working.\r\n");
    return (1);
}
...
int board_display_msg(int board_type, struct char_data *ch, char *arg, struct obj_data *board)
{
    ...
    if (IS_SET_AR(world[IN_ROOM(ch)].room_flags, ROOM_CLAN) &&
            (world[IN_ROOM(ch)].clan_id != GET_CLAN(ch)) &&
            (GET_LEVEL(ch) < LVL_GOD)) {
        sendChar(ch, "You just can't seem to make out anything discernable.\r\n");
        return (1);
    }
    if (!num_of_msgs[board_type]) {
        sendChar(ch, "The board is empty!\r\n");
        return (1);
    }
    if (msg < 1 || msg > num_of_msgs[board_type]) {
        sendChar(ch, "That message exists only in your imagination.\r\n");
        return (1);
    }
#if NEWEST_AT_TOP
    ...
    if (MSG_SLOTNUM(board_type, ind) < 0 ||
        ...
        sendChar(ch, "Sorry, the board is not working.\r\n");
        mlog("SYSERR: Board is screwed up. (Room #%d)", GET_ROOM_VNUM(IN_ROOM(ch)));
        return (1);
    }
    if (!(MSG_HEADING(board_type, ind))) {
        sendChar(ch, "That message appears to be screwed up.\r\n");
        return (1);
    }
    if (!(msg_storage[MSG_SLOTNUM(board_type, ind)])) {
        sendChar(ch, "That message seems to be empty.\r\n");
        return (1);
    }
    snprintf(buffer, sizeof (buffer), "Message %d : %s&00\r\n\r\n%s\r\n&00", msg,
...
int board_remove_msg(int board_type, struct char_data *ch, char *arg, struct obj_data *board)
{
    ...
    if (IS_SET_AR(world[IN_ROOM(ch)].room_flags, ROOM_CLAN) &&
        ...
        sendChar(ch, "Your efforts to remove a message from this board seem to be in vain.\r\n");
        return (1);
    }

    snprintf(buf, sizeof (buf), "(%s)", GET_NAME(ch));
    if (IS_SET_AR(world[IN_ROOM(ch)].room_flags, ROOM_CLAN)) {
        if (!strstr(MSG_HEADING(board_type, ind), buf) && GET_CLAN_RANK(ch) < CLAN_LEADER) {
        ...
        if (GET_LEVEL(ch) < REMOVE_LVL(board_type) &&
            ...
            sendChar(ch, "You are not holy enough to remove other people's messages.\r\n");
            return (1);
        }
        if (GET_LEVEL(ch) < MSG_LEVEL(board_type, ind)) {
            sendChar(ch, "You can't remove a message holier than yourself.\r\n");
            return (1);
        }
    }
    slot_num = MSG_SLOTNUM(board_type, ind);
    if (slot_num < 0 || slot_num >= INDEX_SIZE) {
        sendChar(ch, "That message is majorly screwed up.\r\n");
        mlog("SYSERR: The board is seriously screwed up. (Room #%d)", GET_ROOM_VNUM(IN_ROOM(ch)));
        return (1);
    }
    for (d = descriptor_list; d; d = d->next)
        if (STATE(d) == CON_PLAYING && d->str == &(msg_storage[slot_num])) {
            sendChar(ch, "At least wait until the author is finished before removing it!\r\n");
            return (1);
        }
...
void board_load_board(int board_type)
{
    ...
    if (num_of_msgs[board_type] < 1 || num_of_msgs[board_type] > MAX_BOARD_MESSAGES) {
        mlog("SYSERR: Board file %d corrupt.  Resetting.", board_type);
    ...
    for (i = 0; i < num_of_msgs[board_type]; i++) {
        ...
        if ((MSG_SLOTNUM(board_type, i) = find_slot()) == -1) {
            mlog("SYSERR: Out of slots booting board %d!  Resetting...", board_type);
            board_reset_board(board_type);
            return;
        }
